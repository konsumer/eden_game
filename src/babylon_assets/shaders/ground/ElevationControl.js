(function () {
    ElevationControl = function (ground, location) {
        this._ground = ground;
        this.radius = 5.0;
        ...
        particleSystem.particleTexture = new BABYLON.Texture(location + "/flare.png", scene);
    ...
    ElevationControl.prototype.direction = 1;

    ElevationControl.prototype.attachControl = function (canvas) {
        var currentPosition;
        var that = this;
    ...
    ElevationControl.prototype.detachControl = function (canvas) {
    ...
    ElevationControl.prototype._prepareDataModelForElevation = function () {
    ...
    ElevationControl.prototype._getFaceVerticesIndex = function (faceID) {
        return {
    ...
    ElevationControl.prototype._computeFaceNormal = function (face) {
    ...
    ElevationControl.prototype._getFacesOfVertices = function () {
        this._facesOfVertices = [];
    ...
    ElevationControl.prototype._isBoxSphereIntersected = function(box, sphereCenter, sphereRadius) {
    ...
    ElevationControl.prototype._elevateFaces = function (pickInfo, radius, height) {
    ...
    ElevationControl.prototype._reComputeNormals = function () {
        var faces = [];
        var face;
    ...
    ElevationControl.prototype._computeNormal = function(vertexIndex) {
    ...
    ElevationControl.prototype._updateSubdivisions = function (vertexIndex) {
