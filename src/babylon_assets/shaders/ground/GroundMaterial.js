(function () {
    GroundMaterial = function (name, scene, light, location) {
        this.name = name;
        this.id = name;
        this.light = light;
        ...
        this.groundTexture = new BABYLON.Texture(this.location + "/ground.jpg", scene);
        this.groundTexture.uScale = 6.0;
        this.groundTexture.vScale = 6.0;
        
        this.grassTexture = new BABYLON.Texture(this.location + "/grass.jpg", scene);
        this.grassTexture.uScale = 6.0;
        this.grassTexture.vScale = 6.0;

        this.snowTexture = new BABYLON.Texture(this.location + "/snow.jpg", scene);
        this.snowTexture.uScale = 20.0;
        this.snowTexture.vScale = 20.0;
        
        this.sandTexture = new BABYLON.Texture(this.location + "/sand.jpg", scene);
        this.sandTexture.uScale = 4.0;
        this.sandTexture.vScale = 4.0;
        
        this.rockTexture = new BABYLON.Texture(this.location + "/rock.jpg", scene);
        this.rockTexture.uScale = 15.0;
        this.rockTexture.vScale = 15.0;
        
        this.blendTexture = new BABYLON.Texture(this.location + "/blend.png", scene);
    ...
    GroundMaterial.prototype.isReady = function (mesh) {
        ...
        if (this._cachedDefines != join) {
            ...
            this._effect = engine.createEffect(this.location + "/ground",
                ["position", "normal", "uv"],
