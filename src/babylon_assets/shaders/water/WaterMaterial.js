(function () {
    WaterMaterial = function (name, scene, light, location) {
        this.name = name;
        this.id = name;
        this.light = light;
        ...
        this.bumpTexture = new BABYLON.Texture(this.location + "/water_bump.png", scene);
    ...
    WaterMaterial.prototype.isReady = function (mesh) {
        ...
        this._effect = engine.createEffect(this.location + "/water",
            ["position", "normal", "uv"],
