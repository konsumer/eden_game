...
(function () {
    WORLDMONGER.GroundMaterial = function (name, scene, light) {
        ...
        this.groundTexture = new BABYLON.Texture("assets/shaders/Ground/ground.jpg", scene);
        this.groundTexture.uScale = 6.0;
        this.groundTexture.vScale = 6.0;
        
        this.grassTexture = new BABYLON.Texture("assets/shaders/Ground/grass.jpg", scene);
        this.grassTexture.uScale = 6.0;
        this.grassTexture.vScale = 6.0;

        this.snowTexture = new BABYLON.Texture("assets/shaders/Ground/snow.jpg", scene);
        this.snowTexture.uScale = 20.0;
        this.snowTexture.vScale = 20.0;
        
        this.sandTexture = new BABYLON.Texture("assets/shaders/Ground/sand.jpg", scene);
        this.sandTexture.uScale = 4.0;
        this.sandTexture.vScale = 4.0;
        
        this.rockTexture = new BABYLON.Texture("assets/shaders/Ground/rock.jpg", scene);
        this.rockTexture.uScale = 15.0;
        this.rockTexture.vScale = 15.0;
        
        this.blendTexture = new BABYLON.Texture("assets/shaders/Ground/blend.png", scene);
    ...
    WORLDMONGER.GroundMaterial.prototype.isReady = function (mesh) {
        ...
        if (this._cachedDefines != join) {
            ...
            this._effect = engine.createEffect("./assets/shaders/Ground/ground",
                ["position", "normal", "uv"],
